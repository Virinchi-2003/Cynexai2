      ...
      {isStudentModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
          <div className="bg-erp-surface border border-erp-border rounded-2xl w-full max-w-2xl shadow-2xl">
            <div className="p-5 border-b border-erp-border flex justify-between items-center"><h2 className="font-bold text-xl">Add New Student</h2><button onClick={() => setIsStudentModalOpen(false)}><X className="w-6 h-6" /></button></div>
