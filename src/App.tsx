...
import CourseMgmt from './pages/crm/manager/CourseMgmt';
import UserMgmt from './pages/crm/manager/UserMgmt';
import GlobalTaskAssigner from './pages/crm/manager/GlobalTaskAssigner';
import TimetableManager from './pages/crm/manager/TimetableManager';

// Admin & Student Imports
import AdminDashboard from './pages/admin/AdminDashboard';
import CourseCMS from './pages/teacher/CourseCMS';
  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        <Route path="/sales/tasks" element={<SalesLayout><TaskBoard /></SalesLayout>} />
        <Route path="/sales/chat" element={<SalesLayout><ChatPortal /></SalesLayout>} />
        ...
        <Route path="/manager/users" element={<RequireAuth allowedRoles={['Manager', 'CEO']}><ManagerLayout><UserMgmt /></ManagerLayout></RequireAuth>} />
        <Route path="/manager/tasks" element={<RequireAuth allowedRoles={['Manager', 'CEO']}><ManagerLayout><GlobalTaskAssigner /></ManagerLayout></RequireAuth>} />
        ...
        <Route path="/manager/onboarding/:id" element={<RequireAuth allowedRoles={['Manager', 'CEO']}><ManagerLayout><OnboardingFlow /></ManagerLayout></RequireAuth>} />

        {/* DM Routes */}
        <Route path="/dm/dashboard" element={<RequireAuth allowedRoles={['Digital Marketer', 'Manager', 'CEO']}><DMLayout><DMDashboard /></DMLayout></RequireAuth>} />
        <Route path="/dm/planner" element={<RequireAuth allowedRoles={['Digital Marketer', 'Manager', 'CEO']}><DMLayout><ContentPlanner /></DMLayout></RequireAuth>} />
        ...
        {/* Teacher Routes */}
        <Route path="/teacher" element={<RequireAuth allowedRoles={['Teacher', 'Manager', 'CEO']}><TeacherLayout><TeacherDashboard /></TeacherLayout></RequireAuth>} />
        <Route path="/teacher/cms" element={<RequireAuth allowedRoles={['Teacher', 'Manager', 'CEO']}><TeacherLayout><CourseCMS /></TeacherLayout></RequireAuth>} />
        <Route path="/teacher/live" element={<RequireAuth allowedRoles={['Teacher', 'Manager', 'CEO']}><TeacherLayout><LiveStreamDashboard /></TeacherLayout></RequireAuth>} />
        <Route path="/teacher/attendance" element={<RequireAuth allowedRoles={['Teacher', 'Manager', 'CEO']}><TeacherLayout><AttendanceSystem /></TeacherLayout></RequireAuth>} />
