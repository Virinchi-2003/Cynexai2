...
import { User, Calendar, CreditCard, Tag, BadgeIndianRupee } from 'lucide-react';
              ...
              <tr>
                ...
                {isManager && (
                  <th className="p-4 font-bold text-erp-primary uppercase text-[10px] tracking-wider bg-erp-primary/5">
                    <div className="flex items-center gap-1"><User className="w-3 h-3"/> Executive (Manager View)</div>
                  </th>
                )}
              </tr>
            </thead>
              ...
              {sales.length === 0 ? (
                ...
                sales.map(sale => (
                  <tr key={sale.id} className="hover:bg-erp-primary/5 transition-colors group">
                    ...
                    <td className="p-4 text-sm font-bold text-erp-text/80">{sale.course_id}</td>
                    ...
                    {isManager && (
                      <td className="p-4 bg-erp-primary/5 group-hover:bg-erp-primary/10 transition-colors">
                        <div className="flex items-center gap-2">
                          <div className="w-6 h-6 rounded-full bg-erp-primary/20 text-erp-primary flex items-center justify-center text-xs font-bold">
                            {(sale.executive_name || 'U')[0].toUpperCase()}
                          </div>
              ...
              <Card key={sale.id} className="relative overflow-hidden">
                ...
                <div className="flex justify-between items-start mb-3 pt-2">
                  <div>
                    ...
                    <p className="text-erp-text/50 font-bold text-xs">{sale.course_id}</p>
                  </div>
