            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 w-full lg:w-auto">
              <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-4 text-center">
                <div className="flex items-center justify-center gap-1.5 text-xs font-bold text-slate-400 uppercase tracking-wider mb-1">
                  <Layers className="w-4 h-4 text-indigo-400" /> Total Modules
                </div>
              ...
              <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-4 text-center col-span-2 sm:col-span-1">
                <div className="flex items-center justify-center gap-1.5 text-xs font-bold text-slate-400 uppercase tracking-wider mb-1">
                  <TrendingUp className="w-4 h-4 text-purple-400" /> Active Progress
                </div>
                <div className="text-3xl font-black text-purple-400">{inProgressModulesCount}</div>
        ...
        <div className="candy-panel p-4 space-y-4 !border-2 flex flex-col md:flex-row items-stretch md:items-center justify-between gap-4">
          ...
          <div className="relative flex-1 max-w-md">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-slate-200 dark:border-zinc-800 bg-white dark:bg-black/50 text-slate-900 dark:text-white placeholder:text-slate-400 font-bold text-xs focus:outline-none focus:border-indigo-500"
            />
          </div>
            ...
            filteredModules.map((mod, idx) => {
              ...
              return (
                <div
                  ...
                  className="candy-panel p-5 sm:p-6 flex flex-col md:flex-row items-start md:items-center justify-between gap-6 !border-2 hover:border-indigo-500/50 cursor-pointer group transition-all duration-200"
                >
                    ...
                    <div className="flex-1 min-w-0 space-y-1">
                      <div className="flex items-center justify-between gap-2">
                        <div className="flex items-center gap-2 min-w-0">
                          <h3 className="font-black text-base md:text-lg text-slate-900 dark:text-white group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors truncate">
                            {mod.title}
                          </h3>
                          {isCompleted && (
