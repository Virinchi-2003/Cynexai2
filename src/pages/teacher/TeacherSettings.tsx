      ...
      <div className="flex-1 flex flex-col p-4 md:p-8 min-w-0 overflow-y-auto pb-32">
        ...
        <div className="flex justify-between items-center mb-8">
          ...
          <div className="flex items-center gap-3">
            <button onClick={handleReset} className="flex items-center gap-2 text-sm font-bold text-slate-500 hover:text-slate-700 transition-colors px-3 py-2 rounded-lg hover:bg-slate-100">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              {[
                ...
                <button
                  ...
                  className={`flex-1 flex items-center justify-center gap-1.5 py-2 rounded-lg text-sm font-bold transition-all ${
                    activeTab === tab.id ? 'bg-white shadow text-erp-text' : 'text-erp-text/50 hover:text-erp-text'
                  }`}
                >
                  ...
                  <button
                    ...
                    className={`w-full text-left p-4 rounded-xl border-2 transition-all ${
                      selectedPreset === idx
                        ...
                        : 'border-erp-border hover:border-violet-300 bg-white'
                    }`}
                  >
          ...
          <div className="lg:col-span-2">
            <Card className="h-full flex flex-col">
              ...
              <div className="p-4 border-t border-erp-border bg-slate-50 rounded-b-xl">
                <div className="flex items-center justify-between">
